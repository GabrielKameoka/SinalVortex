...
namespace SinalVortex.Infrastructure.Migrations
{
    ...
    [Migration("20260917222439_PadronizaNomesAuditoria")]
    partial class PadronizaNomesAuditoria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SinalVortex.Domain.Entities.Contato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CanalPreferencial")
            ...
            modelBuilder.Entity("SinalVortex.Domain.Models.Template", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SinalVortex.Domain.Models.Notificacao", b =>
                {
                    b.OwnsOne("SinalVortex.Domain.ValueObjects.Destinatario", "Destinatario", b1 =>
                        {
                            b1.Property<Guid>("NotificacaoId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("NotificacaoId");

                            b1.ToTable("Notificacoes");
